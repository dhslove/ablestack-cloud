...
<script>
const successStates = ['READY', 'CONNECTED', 'TARGET_READY', 'SUCCEEDED', 'ENABLED', 'ACTIVE']
const warningStates = ['DEGRADED', 'RPO_EXCEEDED', 'STALE', 'PAUSED', 'DISABLED', 'FAILBACK_READY']
const errorStates = ['ERROR', 'FAILED', 'DISCONNECTED', 'FENCED']
const infoStates = ['SYNCING', 'MATERIALIZING', 'RUNNING', 'QUEUED', 'CREATED', 'TESTING', 'REPROTECTING']
