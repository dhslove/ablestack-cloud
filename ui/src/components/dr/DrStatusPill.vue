...
const warningStates = ['DEGRADED', 'RPO_DUE_SOON', 'RPO_EXCEEDED', 'STALE', 'PAUSED', 'DISABLED', 'UNPROTECTED', 'FAILBACK_READY', 'FAILED_OVER_UNPROTECTED', 'RETRYING', 'DR_PROJECTION_STALE', 'DR_ENGINE_BUSY_RETRYABLE', 'COMMIT_VERIFYING', 'COMMIT_UNCERTAIN', 'ROLLBACK_FENCING', 'SKIPPED', 'CONSISTENCY_WARNING']
