...
const warningStates = ['DEGRADED', 'RPO_EXCEEDED', 'STALE', 'PAUSED', 'DISABLED', 'UNPROTECTED', 'FAILBACK_READY', 'FAILED_OVER_UNPROTECTED', 'RETRYING', 'DR_PROJECTION_STALE', 'DR_ENGINE_BUSY_RETRYABLE', 'COMMIT_VERIFYING', 'COMMIT_UNCERTAIN', 'ROLLBACK_FENCING', 'SKIPPED', 'CONSISTENCY_WARNING']
const errorStates = ['ERROR', 'FAILED', 'DISCONNECTED', 'FENCED', 'DR_ENGINE_WORKER_STALLED', 'DR_ENGINE_WORKER_FAILED', 'BLOCKED']
const infoStates = ['SYNCING', 'MATERIALIZING', 'RUNNING', 'QUEUED', 'CREATED', 'TESTING', 'REPROTECTING', 'PREPARING', 'DISPATCHING', 'ACCEPTED', 'RESULT_FINALIZING']
